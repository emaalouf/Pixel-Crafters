    ...
    return (
        <div className="bg-white py-20">
            <div className="sm:w-10/12 lg:w-9/12 mx-auto text-center">
                <div className='px-10'>
                    <h1 className="text-blue-950 text-4xl font-bold">We are expert web agency</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    {featuresData.map((feature, index) => {
                        ...
                        return (
                            <div key={index} className="bg-gray-100 hover:bg-[#FFB800] p-8 rounded-lg shadow-lg text-center flex flex-col justify-center items-center  hover:transition hover:scale-105">
